...
import net.kri.webshopping.util.FileUploadUtility;
import net.kri.webshopping.validator.ProductValidator;
		...
		mv.addObject("product", nProduct);
		 if(operation!=null) {
			 if(operation.equals("product")) {
				 ...
				 mv.addObject("message", "Category is Successfully Submitted!");
			 }
		 }
		 return mv;
	}
